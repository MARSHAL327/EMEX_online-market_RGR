...
function changeItemNum(e) {
  ...
  var maxItemNum = +input.attr("max");
  if (newNum < 1 || newNum > maxItemNum) return;
  var id = parentElement.data("id");
  var oneItemPrice = parseInt(parentElement.find(".basket__item__price_one span").text().replace(/\s+/g, ''));
  var allItemPriceElement = parentElement.find(".basket__item__price_all span");
  var fewItemsElement = parentElement.find(".basket__item__few-products span");
...
$(document).ready(function () {
  ...
  $(".product__count-btn__add").on("click", function () {
    ...
    if (newValue <= input.attr("max")) input.val(+input.val() + 1);
  });
  ...
  $(".slider-grid__delete-item").on("click", function (e) {
    e.preventDefault();
    var deletedElement = $(this).parents(".slider-grid__item");
    $.ajax({
      url: "/delete-slide",
      type: "POST",
      dataType: "json",
...
/***/ 0:
/*!*****************************************************************************************!*\
  !*** multi ./resources/js/app.js ./resources/sass/reset.scss ./resources/sass/app.scss ***!
  \*****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! F:\IT\web\OSPanel\domains\RGR-Web\resources\js\app.js */"./resources/js/app.js");
__webpack_require__(/*! F:\IT\web\OSPanel\domains\RGR-Web\resources\sass\reset.scss */"./resources/sass/reset.scss");
module.exports = __webpack_require__(/*! F:\IT\web\OSPanel\domains\RGR-Web\resources\sass\app.scss */"./resources/sass/app.scss");
